...
class BroncoEngine {
	...
	public static function start($options) {
		if(!self::$started) {
            BroncoTemplate::setOptions(array_merge(self::$default_options,$options));
			self::$started = true;
		}
	}
	...
	public static function render($template, $variables = array()) {
		...
		if(!self::$sorted_variables) { // we have yet to encode our variables. Go ahead and do so as neccesarily
